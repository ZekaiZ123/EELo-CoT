...
for num_acc in acc_len:
    for ref_fac in ref_factor:
        ...
        json.dump(json_config_copy, open(f"EELo-CoT/amc23/reasoing_probing_vllm-main_rule/configs/grid1/Qwen2.5-7B_self_neuron_neuron{num_acc}_factor_{ref_fac}_cold4.json", "w"))
